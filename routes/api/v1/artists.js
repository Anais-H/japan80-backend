...
const { getArtistsCtrl, getArtistsCountCtrl, createArtistCtrl, deleteArtistByIdCtrl, getArtistByIdCtrl, updateArtistByIdCtrl } = require('../../../controllers/v1/artist.controller');
